...
This Kirazium branch adds synchronized WebVTT subtitles plus server-local MP4/VTT playback. See the
[Kirazium VTT and local-media guide](docs/KIRAZIUM_VTT_LOCAL_MEDIA.md) for setup and commands.
